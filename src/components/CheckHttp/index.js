            ...
            <section>
			    <div className="container mt-3">
			        <div className="border rounded">
			            <Title title="Check website <span class='text-main'>hoangphiit.com</span>"/>
			                        ...
			                        <table className="table table-bordered table-hover m-0">
			                            <tbody>
			                                <tr className="bg-white">
			                                    ...
			                                    <th className="py-1 align-middle border-white">Time</th>
			                                    <th className="py-1 align-middle border-white">Code</th>
			                                </tr>
			                                <tr className="bg-f3f3f3">
			                                    ...
			                                    <th className="py-1 align-middle font-weight-normal">OK</th>
			                                    <th className="py-1 align-middle font-weight-normal">0.262 seconds</th>
			                                    <th className="py-1 align-middle font-weight-normal">200 (OK)</th>
			                                </tr>
			                                <tr className="bg-f3f3f3">
			                                    <th className="py-1 align-middle font-weight-normal">
			                                        <img src={ukFlag} alt="UK" width={20} className="mr-1"/>
