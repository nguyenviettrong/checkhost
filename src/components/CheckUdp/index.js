            ...
            <section>
			    <div className="container mt-3">
			        <div className="border rounded">
			            <Title title="UDP connect <span class='text-main'>hoangphiit.com</span>"/>
			                        ...
			                        <table className="table table-bordered table-hover m-0">
			                            <tbody>
			                                ...
			                                <tr className="bg-f3f3f3">
			                                    ...
			                                    <th className="py-1 align-middle font-weight-normal">Open or filtered</th>
			                                </tr>
			                                <tr className="bg-f3f3f3">
			                                    <th className="py-1 align-middle font-weight-normal">
			                                        <img src={ukFlag} alt="UK" width={20} className="mr-1"/>
			                                ...
			                                <tr className="bg-f3f3f3">
			                                    ...
			                                    <th className="py-1 align-middle font-weight-normal text-danger">Unknown host</th>
			                                </tr>
			                                <tr className="bg-f3f3f3">
			                                    <th className="py-1 align-middle font-weight-normal">
			                                        <img src={ukFlag} alt="UK" width={20} className="mr-1"/>
